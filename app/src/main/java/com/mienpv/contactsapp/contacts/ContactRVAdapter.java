...
import com.mienpv.contactsapp.ContactDetailActivity;
import com.mienpv.contactsapp.utils.TextDrawable;
import com.mienpv.contactsapp.utils.ColorGenerator;
    ...
    public void onBindViewHolder(@NonNull ContactRVAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("email", modal.getEmailName());
